	  ...
	  <div class="container-fluid">
	    ...
	    <div class="collapse navbar-collapse" id="navbarText">
	      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
	        ...
	        <li class="nav-item">
	          <a class="nav-link" href="appointment.jsp">Admin Users Management</a>
	        </li>
	        
			<li class="nav-item">
	          <a class="nav-link" href="appointment.jsp">Manage Doctors</a>
	        </li>
	        
	        <li class="nav-item">
	          <a class="nav-link" href="appointment.jsp">View Bookings</a>
	        </li>
	      </ul>
