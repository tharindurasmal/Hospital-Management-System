...
<div class="bg-primary text-white text-center py-5">
  <h1 class="display-4">About Mecare Hospital</h1>
...
<div class="container my-5">
  <div class="row align-items-center mb-5">
    ...
    <div class="col-md-6">
      ...
      <p class="text-muted">
        Mecare Hospital is a trusted name in healthcare, known for delivering advanced medical care with compassion. With decades of experience, we focus on innovation, quality treatment, and community wellness.
      </p>
    </div>
  </div>
  ...
  <div class="text-center mb-5">
    <h3 class="mb-3">Why Choose Mecare?</h3>
